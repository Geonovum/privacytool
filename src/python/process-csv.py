...
if len(sys.argv) != 2:
    ...
    filename = sys.argv[1]
    html = """<div id='onverenigbaarheid-%s' class="radioQuestion score">
                                                    <div class="checkboxIntro">%s. %s                                   
                                                        <div class="inputarea">  
                                                            ...
                                                            <input id="onverenigbaarheid-%s-nvt" name="onverenigbaarheid-%s" type="radio" value="0" onchange="checkRadioQuestion(this.id, this.name, this.value)"/><label for="onverenigbaarheid-%s-nvt">n.v.t.</label>
                                                        </div>                                                       
                                                    </div>
